...
export default function Portfolio() {
        ...
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://www.linkedin.com/in/peter-good/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition">
  ...
  target="_blank" 
  className="px-8 py-4 bg-slate-900 border border-slate-800 rounded-2xl font-bold hover:bg-slate-800 transition"
>
  Resume PDF
</a>
            </div>
